...
package ru.innopolis.homeworks.week3.homework12.dao;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import ru.innopolis.homeworks.week3.homework12.entity.Person;
import ru.innopolis.homeworks.week3.homework12.entity.Subject;
...
public class CourseDAOImpl implements CourseDAO {
    ...
    public void createPerson(Person person) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(INSERT_PERSON)) {
            ...
            LOGGER.error("Error while preparing or executing the insert statement to the database: " + e.getMessage());
        }
        ...
        try (PreparedStatement statement = connection.prepareStatement(SELECT_PERSON_ID_BY_NAME)) {
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    person.setId(id);
                    LOGGER.info("Field 'id' of " + person.getName() + " has changed successfully");
                }
            } catch (SQLException e) {
                LOGGER.error("Error while executing query to the database: " + e.getMessage());
            }
        } catch (SQLException e) {
            LOGGER.error("Error while preparing statement for the query: " + e.getMessage());
        }
    }
    ...
    public void updatePerson(Person person) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_PERSON)) {
            ...
            LOGGER.error("Error while preparing or executing the update statement to the database: " + e.getMessage());
        }
    }
    ...
    public void deletePerson(Person person) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(DELETE_PERSON)) {
            ...
            LOGGER.error("Error while preparing or executing the delete statement to the database: " + e.getMessage());
        }
    }
