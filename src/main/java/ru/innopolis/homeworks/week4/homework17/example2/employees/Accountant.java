...
package ru.innopolis.homeworks.week4.homework17.example2.employees;

import java.math.BigDecimal;
import java.time.LocalDate;

/**
 * Бухгалтер является работником и реализует методы {@code paySalary()} и {@code dismiss()}.
 */
public class Accountant implements Employee {
    ...
    private BigDecimal salary = new BigDecimal(25_000);
    ...
    @Override
    public void dismiss() {
        System.out.printf("Accountant %s was dismissed on %s\n", name, time);
    }
