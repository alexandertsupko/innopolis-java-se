...
public class Main {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        sb.append("package ru.innopolis.lectures.week2.lecture07;public class ").append(className).append(" {{System.out.println(\"Хоттабыч2\");}}");
        try {
        ...
        Class<?> kindClass = cl.loadClass("ru.innopolis.lectures.week2.lecture07.KindMagic");
